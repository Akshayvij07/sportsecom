...
// @Accept json
// @Produce json
// @Param category_name body request.Category true "New category name"
...
// @Param category_details body request.Category true "category info"
// @Success 200 {object} respondse.Response
// @Failure 400 {object} respondse.Response
...
// @Accept json
// @Produce json
// @Param new_product_details body request.Product true "new product details"
// @Success 200 {object} respondse.Response
// @Failure 400 {object} respondse.Response
...
// @Param category_details body request.Product true "Product info"
// @Success 200 {object} respondse.Response
// @Failure 400 {object} respondse.Response
...
// @Success 200 {object} respondse.Response
// @Failure 500 {object} respondse.Response
// @Router /product/AllProducts [get]
func (cr *ProductHandler) UserProductslist(c *gin.Context) {
	...
	listProducts := request.Pagination{
		Page:    uint(page),
...
// @Success 200 {object} respondse.Response
// @Failure 500 {object} respondse.Response
// @Router /admin/product/ViewAllProducts [get]
